# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-08 20:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_term', models.CharField(choices=[('PIA', 'Payment in advance'), ('EOM', 'End of the month'), ('CWO', 'Chash with order')], default='EOM', max_length=50)),
                ('shipping_term', models.CharField(choices=[('CIF', 'Cost, Insurance and Freight'), ('COP', 'Customs of the Port'), ('DWT', 'Deadweight Tonnage')], default='CIF', max_length=50)),
        ...
        migrations.AddField(
            model_name='customer',
            name='category_code',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customer.CustomerCategory'),
        ),
    ]
