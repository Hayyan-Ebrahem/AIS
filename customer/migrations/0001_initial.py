# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-08-03 10:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit_limit', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=10)),
                ('period_unit', models.TextField(choices=[('day', 'day'), ('month', 'month'), ('year', 'year')], default='day')),
                ('credit_period', models.DurationField(choices=[(datetime.timedelta(30), '30'), (datetime.timedelta(60), '60'), (datetime.timedelta(90), '90')], default=datetime.timedelta(30))),
                ('payment_term', models.CharField(choices=[('PIA', 'Payment in advance'), ('EOM', 'End of the month'), ('CWO', 'Cash with order')], default='EOM', max_length=50)),
                ('shipping_term', models.CharField(choices=[('CIF', 'Cost, Insurance and Freight'), ('COP', 'Customs of the Port'), ('DWT', 'Dead weight Tonnage')], default='CIF', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customer.Category')),
        ...
        migrations.AddField(
            model_name='customer',
            name='category_code',
            field=models.ManyToManyField(through='customer.CustomerCategory', to='customer.Category'),
        ),
    ]
