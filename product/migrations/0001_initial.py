# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-11 17:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('max_stock_level', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('min_stock_level', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('recorded_stock_level', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
